...
![ci-jenkins-gitea-scan](images/ci-jenkins-gitea-scan.png)

![ci-jenkins-pipeline](images/ci-jenkins-pipeline.png)

![ci-jenkins-warnings-ng](images/ci-jenkins-warnings-ng.png)
